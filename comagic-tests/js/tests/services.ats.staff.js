tests.addTest(function(args) {
    ...
    describe('Открываю страницу сотрудников.', function() {
        ...
        describe('Нажимаю кнопку "Создать статус". Нажимаю на пункт меню "Новый статус".', function() {
            beforeEach(function() {
                tester.button('Создать статус').click();
                tester.menu.item('Новый статус').click();
            });

            it('Заполняю поля формы. Нажимаю на кнпоку "Создать". Отправлен запрос сохранения статуса.', function() {
                tester.floatingForm.
                    iconField().
