...
module.exports = {
  ...
  jwt: {
    ...
    token_secret: '1izwQFUuOnxkgGAqgNMzKz7buegV7xMUDmHjnmY3Q98zr5uvRK58cnEjKgOoKsz'
  },
  ...
  session: {
      ...
      // Generate using: https://www.grc.com/passwords.htm
      secret: 'yvR1O4nNRWeQO8dTznZXFjKQlN8mjAEaC5V1ul9FIhf0BRTbaRMSErNnPkUYGuG',
  ...
  files: {
    ...
    dirname: '/usr/local/src/tests/assets',
