            ...
            describe('Ввожу логин и пароль. Отправлен запрос авторизации.', function() {
                ...
                describe('URL бэкенда не указан.', function() {
                            ...
                            describe('SIP-линия зарегистрирована.', function() {
                                ...
                                describe('Получен доступ к микрофону.', function() {
                                    ...
                                    describe('Инициализируется SDK Битркс24.', function() {
                                        ...
                                        xdescribe('Включен режим "IP-телефон".', function() {
                                            beforeEach(function() {
                                                tester.othersNotification().
                                                    widgetStateUpdate().
                    ...
                    it(
                        ...
                        'отклонен.',
                    function() {
                        settingsRequest.twoChannels().receiveResponse();
                        tester.masterInfoMessage().receive();
                        ...
                        tester.incomingCall().anotherPhoneNumber().busy().receive();
                    });
                });
                return;
                describe('URL бэкенда указан. Запрос авторизации отсылается заново по указанному URL.', function() {
                    beforeEach(function() {
                        ...
                        authTokenRequest.appUrlSpecified().receiveResponse();

                        authTokenRequest = tester.authorizationRequest().
                            appUrlSpecified().
                            anotherUrl().
                            expectToBeSent();
                    });
                    ...
                    it('Запросы отправляются по указанному URL.', function() {
                        ...
                        tester.authCheckRequest().anotherUrl().receiveResponse();
                        tester.talkOptionsRequest().receiveResponse();
                        tester.statusesRequest().receiveResponse();
                        tester.permissionsRequest().receiveResponse();
                        tester.settingsRequest().receiveResponse();
                        ...
                        tester.ISWebsocket.anotherUrl().connect();
