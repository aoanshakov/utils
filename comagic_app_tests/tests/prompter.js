tests.addTest(options => {
    ...
    describe(
        'Открываю новый личный кабинет. Фичафлаг софтфона включен. Вкладка является ведущей. Получены права. ' +
        'Получены настройки софтфона. Получен доступ к микрофону. SIP-линия зарегистрирована. Получены данные для ' +
        'отчета. SIP-регистрация завершена.',
    function() {
        let tester,
            reportGroupsRequest,
            settingsRequest,
        ...
        it(
            'Получена информация о звонке. Происходит подготовка к подключению ко звонку. Номер клинета неизвестен. ' +
            'Поступил входящий звонок с ожидаемого номера. Отображен номер полученный из события входящего звонка.',
        function() {
